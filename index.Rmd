---
title: "Mapa de conectividad de grupos funcionales de aves migratorias en el cantón de Curridabat"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos-conectividad/master/curridabat/migratorias/PROBABILIDAD_CONECTIVIDAD_MIGRATORIAS_CURRIDABAT_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_migratorias_curridabat/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_migratorias_curridabat/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.00001334, 0.00003450, 0.00012895, 0.00064006, Inf)
...
# Importancia
bins_importancia <- c(0, 35122105658.60, 98243148906.20, 179729417323.00, 2194945748030.00, Inf)
